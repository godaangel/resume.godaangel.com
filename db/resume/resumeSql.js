var resumeSql = {
  ...
  queryByUsername: "select SQL_CALC_FOUND_ROWS id,username,work_year,title,position,department,update_time from resume_list where username like ? and department like ? limit ?, ?",
